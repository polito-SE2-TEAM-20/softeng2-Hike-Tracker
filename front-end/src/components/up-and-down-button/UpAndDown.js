            ...
            <Row style={{width: "fit-content", margin: "auto"}}>
                <Col style={{padding: "1px"}}>
                    <div style={{backgroundColor: "white", borderTopLeftRadius: "6px", borderBottomLeftRadius: "6px"}}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="#1a1a1a" class="bi bi-arrow-up" viewBox="0 0 16 16">
                ...
                <Col style={{padding: "1px"}}>
                    <div style={{backgroundColor: "white", borderTopRightRadius: "6px", borderBottomRightRadius: "6px"}}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="#1a1a1a" class="bi bi-arrow-down" viewBox="0 0 16 16">
